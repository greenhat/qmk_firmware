...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    KC_LCTL, KC_NO, KC_GRV, MT(MOD_LALT, KC_GRAVE), MT(MOD_LGUI, KC_LBRACKET), MT(MOD_LCTL, KC_ESC), MT(MOD_LSFT, KC_SPC),       MT(MOD_RSFT, KC_BSPC),  MT(MOD_RCTL, KC_DELETE), LT(_NAV, KC_RBRACKET), MT(MOD_RALT, KC_BSLASH), KC_GRV, KC_NO, KC_ENT
  ),
